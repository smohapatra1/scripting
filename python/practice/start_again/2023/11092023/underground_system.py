...
def checkIn(id: int, stationName: str, t: int ) -> None:
    self.check_ins[id] = (stationName, t )

def checkOut(id: int, stationName: str, t: int) -> None:
...
def getAverageTime(id: int, startStation: str, endStation: str ) -> float:
