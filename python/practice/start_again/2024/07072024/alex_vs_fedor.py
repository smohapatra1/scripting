# #   https://www.hackerrank.com/challenges/alex-vs-fedor/problem?isFullScreen=true
...
# The function accepts WEIGHTED_INTEGER_GRAPH graph as parameter.
#
...
if __name__ == '__main__':
    ...
    graph_nodes, graph_edges = map(int, input().rstrip().split())
    ...
    for i in range(graph_edges):
        graph_from[i], graph_to[i], graph_weight[i] = map(int, input().rstrip().split())
