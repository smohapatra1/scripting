#   https://www.geeksforgeeks.org/python/simple-attendance-tracker-using-python/
...
book = openpyxl.load_workbook('/Users/smohapatra/Documents/Personal/git_workspace/samar/scripting/python/practice/start_again/2025/11292025/attendance.xlsx')
sheet = book['Sheet1']
r = sheet.max_row
resp = 1 
c = sheet.max_column
...
l2 = ""
l3 = []
staff_email = ['sam1@gmail.com', 'sam2@gmail.com']
...
def savefile():
    book.save(r'/Users/smohapatra/Documents/Personal/git_workspace/samar/scripting/python/practice/start_again/2025/11292025/attendance.xlsx')
    print("saved!")
